...
export const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center dark:bg-neutral-900 px-4">
      <div className="w-full max-w-xl sm:w-3/4 md:w-2/3 lg:w-1/2 bg-white dark:bg-neutral-900 border border-gray-200 dark:border-neutral-700 rounded-xl shadow-2xs p-6 sm:p-7">
        <div className="text-center">
          <h1 className="block text-2xl font-bold text-gray-800 dark:text-white">Sign in</h1>
          <p className="mt-2 text-sm text-gray-600 dark:text-neutral-400">
            Don't have an account yet?
            <a className="text-blue-600 decoration-2 hover:underline focus:outline-hidden focus:underline font-medium dark:text-blue-500 cursor-pointer" onClick={() => navigate('/register')}>
              Sign up here
            </a>
          </p>
        </div>
